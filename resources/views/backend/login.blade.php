    ...
    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
        <div class="d-flex flex-column align-content-end">
            <div class="app-auth-body mx-auto">
                <div class="app-auth-branding mb-4"><a class="app-logo" href="index.html"><img class="logo-icon me-2" src="/backend/assets/images/app-logo.svg" alt="logo"></a></div>
                <h2 class="auth-heading text-center mb-5">Admin Giriş</h2>
                ...
                <div class="auth-form-container text-start">
                    <form class="auth-form login-form" method="post" action="{{route('login.authenticate')}}">
                        @csrf
                            ...
                            <div class="extra mt-3 row justify-content-between">
                                ...
                                <div class="col-6">
                                    <div class="forgot-password text-end">
                                        <a href="reset-password.html">Şifre mi Unuttum?</a>
                                    </div>
                                </div><!--//col-6-->
                            </div><!--//extra-->
                        </div><!--//form-group-->

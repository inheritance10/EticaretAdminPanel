	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                        ...
                        <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                ...
                                <li class="submenu-item"><a class="submenu-link" href="login.html">Yöneticiler</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="signup.html">Kullanıcı Kaydı Oluştur</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="reset-password.html">Ayarlar</a></li>
                            </ul>
                        </div>
                    </li><!--//nav-item-->
                    <li class="nav-item">
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                            ...
                            <span class="nav-link-text">Görevler</span>
                        </a><!--//nav-link-->
                    </li><!--//nav-item-->
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
